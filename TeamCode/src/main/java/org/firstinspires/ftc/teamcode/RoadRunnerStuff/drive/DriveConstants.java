...
public class DriveConstants {
    ...
    /*
     * These values are used to generate the atrjectories for you robot. To ensure proper operation,
    ...
    public static double MAX_ANG_VEL = Math.toRadians(265.045);
    public static double MAX_ANG_ACCEL = Math.toRadians(261.7358490566038);
